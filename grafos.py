...
def infosGraph(vertices, arestasL, arestasR):
    ...
    with open("./saida/saida.txt", 'w') as arquivo:
...
def listaAdjacencia(arestasL, arestasR):
    ...
    with open("./saida/lista-adjacencia.txt", 'w') as arquivo:
...
def matrizAdjacencia(arestasL, arestasR):
    ...
    with open("./saida/matriz-adjacencia.txt", 'w') as arquivo:
...
def buscaLargura(G, vertice):
    try:
        ...
        with open('./saida/buscaLargura.txt', 'w') as f:
...
def buscarComponentes(G):
    try:
        ...
        minimo = 100000
        maximo = 0
        with open('./saida/componentes.txt', 'w') as f:
